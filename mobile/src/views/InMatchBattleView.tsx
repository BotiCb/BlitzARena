    ...
    <View style={styles.container}>
      ...
      {healthPoints ? (
        <View>
          ...
          <Button
            title="Shoot"
            onPress={() => gunHandling.shoot(getHitPerson())}
            disabled={!gunHandling.isAbleToShoot}
          />
          <ReloadButton onClick={() => gunHandling.reload()} date={gunHandling.nextShootAt} isReloading={gunHandling.isReloading}/>
        </View>
      ) : (
